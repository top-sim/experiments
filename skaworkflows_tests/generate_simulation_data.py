...
# Imaging HPSOs
LOW_HPSO_PATH = Path("skaworkflows_tests/maximal_low_imaging.json")
MID_HPSO_PATH = Path("skaworkflows_tests/maximal_mid_imaging.json")
...
# Output directories
LOW_OUTPUT_DIR = Path(f"skaworkflows_tests/low_base")
MID_OUTPUT_DIR = Path(f"skaworkflows_tests/mid_base")

LOW_OUTPUT_DIR_PAR = Path(f"skaworkflows_tests/low_parallel")
MID_OUTPUT_DIR_PAR = Path(f"skaworkflows_tests/mid_parallel")
