...
hpso_path_telescope = (
    "chapter4/topsim_scalability_tests/maximal_low_imaging_scalability_telescope.json"
)

hpso_path_channels = (
    "chapter4/topsim_scalability_tests/maximal_low_imaging_scalability_channels.json"
)

BASE_DIR = Path(f"/home/rwb/Dropbox/University/PhD/experiment_data/chapter4/scalability")
...
config_generator.create_config('low', 'parametric', nodes=32,
    hpso_path=Path(hpso_path_channels), output_dir=Path(low_path_str)/'prototype',
