...
BASE_PATH = Path(
    "/home/rwb/Dropbox/University/PhD/experiment_data/chapter4/scheduling/low/")
...
def run_shadow_on_workflows():
    ...
    shadow_config = config_to_shadow(
        Path("/home/rwb/Dropbox/University/PhD/experiment_data"
             "/chapter4/scheduling/low/prototype/skaworkflows_2024-06-02_14-00-32.json"))
    env = Environment(shadow_config, dictionary=True)
    workflow = Workflow(
        "/home/rwb/Dropbox/University/PhD/experiment_data/chapter4/scalability/low_maximal/prototype/workflows/-6190016813116619223_2024-06-02_14:00:32")
