...
# cfg_path_scatter = Path('/home/rwb/Dropbox/University/PhD/experiment_data/chapter4/initial_results/low/scatter/no_data_low_sdp_config_scatter_n896_896channels_single.json')
...
if __name__ == '__main__':
    st = time.time()
    LOGGER.info(f"Running experiment from {RUN_PATH}/")
